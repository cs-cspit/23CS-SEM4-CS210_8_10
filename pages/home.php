...
<head>
    ...
    <title>DGB Bank - Putting fun in funds since 1969</title>
                    ...
                    <div class="row">
                        ...
                        <ul class="list-inline">
                            <li class="list-inline-item bank-phone"> <img src="../assets/img/home-call.png"
                                    height="20px" class="zoom-on-hover"> +91 9819102869</li>
    ...
    <footer id="contact">
        <div class="container pt-5 pb-3">
            <div class="row">
                <div class="col-lg-3">
                    <h5>About</h5>
                    <p>DGB Bank was founded by the one and only, DGB, a financial wizard with a passion
                        for puns.</p>
                    <ul class="list-inline">
                        <li class="list-inline-item"><a href="#"><i class="fab fa-facebook fa-lg"
                                    id="icon-awesome"></i></a></li>
